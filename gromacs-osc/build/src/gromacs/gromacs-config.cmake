...
if (DEFINED GROMACS_SUFFIX AND NOT "${GROMACS_SUFFIX}" STREQUAL "_osc")
    message(FATAL_ERROR "GROMACS_SUFFIX is set inconsistently, expected '_osc'")
endif()
set(GROMACS_SUFFIX "_osc")
set(GROMACS_CXX_COMPILER "/usr/bin/x86_64-linux-gnu-g++-7")
set(GROMACS_CXX_COMPILER_ID "GNU")
set(GROMACS_CXX_COMPILER_VERSION "7.5.0")
set(GROMACS_CXX_FLAGS "")
