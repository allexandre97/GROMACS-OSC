...
set_target_properties(Gromacs::gmxapi PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libgmxapi_osc.so.0.2.1"
  IMPORTED_SONAME_RELEASE "libgmxapi_osc.so.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS Gromacs::gmxapi )
list(APPEND _IMPORT_CHECK_FILES_FOR_Gromacs::gmxapi "${_IMPORT_PREFIX}/lib/libgmxapi_osc.so.0.2.1" )
